...
import bars from "../../public/assets/icon/bars.svg";
...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {isMobile && (
        <>
          <button className="btn nav-toggle-buttn" onClick={toggleNav}>
            {isNavOpen ? <img src={cross} alt="" /> : <img src={bars} alt="" />}
          </button>
          <div className={`mobile-nav ${isNavOpen ? "" : "d-none"}`}>
          <NavLink
            to="/About"
            className={({ isActive }) =>
              `navicon-div text-decoration-none ${
                isActive ? "text-white" : " text-lite"
              }`
            }
          >
            About
